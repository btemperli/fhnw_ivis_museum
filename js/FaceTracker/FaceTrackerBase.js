...
(function(lib, cjs) {
	...
	(lib.FaceTrackerBase = function(
		...
		_this._cameraResolution		= cameraResolution	|| new lib.Rectangle(   0,   0,  555, 380),	// Camera resolution
		_this._brfResolution		= brfResolution		|| new lib.Rectangle(   0,   0,  555, 380),	// BRF BitmapData size
		_this._brfRoi				= brfRoi			|| new lib.Rectangle(   0,   0,  555, 380),	// BRF region of interest within BRF BitmapData size
		_this._faceDetectionRoi		= faceDetectionRoi	|| new lib.Rectangle(   0,   0,  555, 380),	// BRF face detection region of interest within BRF BitmapData size
		_this._screenRect			= screenRect		|| new lib.Rectangle(   0,   0,  555, 380),	// Shown video screen rectangle
